        ...
        <div class="offset-2 col-8">
            <div class="row d-flex flex-column">
                <form method="post" action="" enctype="multipart/form-data">
                    ...
                    <label style="margin-top: 10px;" for="arquivo">Nome do arquivo</label>
                        <input type="text" class="form-control" name="name">
                    ...
                    <input type="text" onkeypress="return onlynumber();" class="form-control" name="name">
                    <!--
                ...
                <form method="post" action="" enctype="multipart/form-data">
                    ...
                    <div id="anexo" style="display: show;">
                        ...
                        <label style="margin-top: 10px;" for="edital">Nome do anexo</label>
                            <input type="text" class="form-control" name="name">
                        <label style="margin-top: 10px;" for="arquivo">Nome do arquivo do anexo</label>
                            <input type="text" class="form-control" name="name">
                        <label style="margin-top: 10px;" for="arquivo">Selecione o arquivo</label>
                            <input type="file" name="arquivo" id="arquivo">    
                            <br>
